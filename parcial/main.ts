...
import obtainContactos from "./resolvers/obtainContactos.ts";
import getbyDNI from "./resolvers/getbyDNI.ts";
...
app
  .get("/api/contactos", obtainContactos)
  
  .get("/api/contactos/:dni",getbyDNI)
